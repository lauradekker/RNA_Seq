...
p1_fwd=/data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/data/parent/P1_L3_R1_001_9L0tZ86sF4p8.fastq.gz
p1_rev=/data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/data/parent/P1_L3_R2_001_yd9NfV9WdvvL.fastq.gz

#runs hisat2 on para strand P1
hisat2 -p 8 --dta -x $ref_idx -1 $p1_fwd -2 $p1_rev -S P1_L3.sam
