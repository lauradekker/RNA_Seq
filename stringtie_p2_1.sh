...
#SBATCH --job-name=stringtie_p2_1
#SBATCH --nodes=1
...
sorted_bam="/data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/results/hisat2/bam/bam_sorted/bam_p2_sorted.bam"
...
stringtie -o transcriptome_assembly_p2.gtf --rf -G $ref_ann $sorted_bam
