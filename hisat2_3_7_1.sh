...
#runs hisat2 on para strand 3_7
hisat2 -p 8 --dta -x $ref_idx -1 /data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/data/para/3_7_L3_R1_001_Tjox96UQtyIc.fastq.gz -2 /data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/data/para/3_7_L3_R2_001_f60CeSASEcgH.fastq.gz -S 3_7_L3.sam
