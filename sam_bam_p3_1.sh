...
sam_p3=/data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/results/hisat2/sam/P3_L3.sam

#convert sam to bam
samtools view -b -t $sam_index $sam_p3 > bam_p3_unsorted.bam

#sort bam file
samtools sort -o bam_p3_sorted.bam bam_p3_unsorted.bam

#index sorted bam file
samtools index bam_p3_sorted.bam
