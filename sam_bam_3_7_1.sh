...
sam_3_7=/data/courses/rnaseq_course/lncRNAs/Project2/users/ldekker/results/hisat2/sam/3_7_L3.sam

#convert sam to bam
samtools view -b -t $sam_index $sam_3_7 > bam_3_7_unsorted.bam

#sort bam file
samtools sort -o bam_3_7_sorted.bam bam_3_7_unsorted.bam

#index sorted bam file
samtools index bam_3_7_sorted.bam
